...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensors', choices=SENSORS, nargs='+', default=['CAM_FRONT_LEFT', 'CAM_FRONT', 'CAM_FRONT_RIGHT', 'CAM_BACK_RIGHT', 'CAM_BACK', 'CAM_BACK_LEFT'])
    parser.add_argument('-o', '--output-gif', type=Path)
    parser.add_argument('-d', '--duration', type=int, default=200, help='Durations for each frame in milliseconds.')
