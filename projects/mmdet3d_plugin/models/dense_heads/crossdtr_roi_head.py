...
class CrossdtrROIHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is CrossdtrROIHead):
        ...
        super(CrossdtrROIHead, self).__init__(num_classes, in_channels, init_cfg=init_cfg)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is CrossdtrROIHead:
            convert_dict = {
    ...
    def get_depth_map_and_gt_bboxes_2d(
        ...
        for gt_bboxes, img_meta in zip(gt_bboxes_list, img_metas):
            ...
            roi_depths.append(roi_depth_all_camera)
        ...
        return gt_depth_maps, gt_bboxes_2d, roi_depths
